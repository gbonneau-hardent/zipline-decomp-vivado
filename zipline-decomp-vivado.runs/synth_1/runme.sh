...
HD_PWD='C:/Users/guy/xilinx_project/zipline-decomp-vivado/zipline-decomp-vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cr_cddip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cr_cddip.tcl
